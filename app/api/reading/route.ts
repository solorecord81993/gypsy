...
const OUTPUT_SCHEMA = {
  ...
  properties: {
    headline: { type: "string", description: "คำตอบต่อคำถามโดยตรงหนึ่งถึงสองประโยค หากมีเงื่อนไขต้องระบุสิ่งที่ต้องทำอย่างเจาะจงในประโยคเดียวกัน" },
